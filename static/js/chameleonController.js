...
const sectionHeader = document.querySelector(".custom-shape-divider-bottom-1650703714 .shape-fill")
const section = document.querySelector(".content");

button.addEventListener("click", () => {
  //Get a random color.
  let color = "#";
  const colorRandom = Math.random().toString(16).slice(2, 8);
  //Change the background color.
  color += colorRandom;
  sectionHeader.style.fill = color;
  section.style.backgroundColor = color;
  //Get the name of the color.
  var hexadecimalNumber = color;
  var nameMatch = ntc.name(hexadecimalNumber);
  //Set the name in the html.
  backgroundColorName.innerText = nameMatch[1];
});